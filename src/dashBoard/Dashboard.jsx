            ...
            <div className="w-64 min-h-screen bg-violet-950 text-white text-xl">
                <ul className="menu p-6  ">
                  ...
                  }
                  {
                    ...
                    <NavLink to='/dashboard/requested'><li className="mb-2 text-xl ">Requested</li></NavLink>
                    </>
                  ...
                  }
                  {
                    ...
                    <NavLink to='/dashboard/user'><li className="mb-2 text-xl">User Profile</li></NavLink>
                    <NavLink to='/dashboard/wishlist'><li className="mb-2 text-xl">Wishlist</li></NavLink>
                    <NavLink to='/dashboard/bought'><li className="mb-2 text-xl">Property bought</li></NavLink>
