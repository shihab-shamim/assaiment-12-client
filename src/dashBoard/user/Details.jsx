...
const Details = () => {
    ...
    const handleWishlist =async (property) =>{
        ...
        const {title,location,minPrice,manPrice,agentEmail,agentImage,agentName,image,status}=property
        
        const wishInfo={title,location,minPrice,manPrice,agentEmail,agentImage,agentName,image,status,userEmail}
    ...
    const handleSubmit =async (review)=>{
        ...
        const reviwerInfo ={reviewText,reviewId,reviwerImage,reviwerName,reviewerEmail}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4  gap-4">
          {
                reviews.map(review=><div key={review._id} className="card w-96 bg-base-100 shadow-xl">
                    <div className="card-body">
                      <h2 className="card-title">Reviewer Name :{review.reviwerName}</h2>
